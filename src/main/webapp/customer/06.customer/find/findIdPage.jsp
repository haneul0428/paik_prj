...
$(function(){
	...
	//실시간 입력 검증
	$("#name, #phone2, #phone3").on("input", function() {
		if (firstClickFlag) {
			chkName();
			chkPhone();
		}//if
...
<div class="sub_section cmnt_wrap">
	<div class="container" style="max-width: 600px; margin: 0 auto; text-align: center;">
        ...
        <form action="findId_process.jsp" id="findIdFrm" method="post">
            ...
            <table>
            	...
            	<tr>
            		<td><input type="button" id="findIdBtn" class="findIdBtn" value="확인"/></td>
            	</tr>
            </table>
            </div>
        </form>
