...
<%
	...
	int selectItemRan = Math.min(5, coffeeItems.size());	//최대 5개의
	List<Integer> selectInd = new ArrayList<Integer>();
	
	while(selectInd.size()<selectItemRan){
		int ranInd = ranItem.nextInt(coffeeItems.size());
	...
	<div class="txt">
		...
		<div class="tabMenu">
			<ul class="pageTab">
				...
				<li class="on"><a href="http://localhost/paik_prj/customer/02.menu/coffeeMenuPage.jsp">커피</a></li>
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				for(int i=0; i<selectInd.size(); i++){
					...
					ItemVO item = coffeeItems.get(ind);
				%>
