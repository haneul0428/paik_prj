	    ...
	    $(function(){
	    	$(".changeReceive").click(function(){
				...
				if(confirm("상태를 변경하시겠습니까?")){
					...
					$.ajax({
						url: "change_not_receive_process.jsp",
						type: "post",
						data: param,
						dataType: "json",
						error:function(xhr){
						...
						success:function(jsonObj){
							if(jsonObj.result){//post 방식으로 잘 실행되었을 경우
								if(jsonObj.update){//양 변경에 성공했을 경우
									alert("상태를 변경했습니다.");
									var url = "http://localhost/paik_prj/manager/order/selectReceivedOrderList.jsp";
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <table id="not-received">
        ...
        <tr>
        	...
        	<td>
        	<input type="button" class="btn btn-warning btn-sm changeReceive" value="변경">
